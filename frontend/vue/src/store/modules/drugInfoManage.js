import {
    ...
    deleteDrug,
    modifyDrugInfo,
  } from "../../api/admin/drugInfoManage.js";
  ...
  const actions = {
    ...
    modifyDrugInfo(
      { dispatch },
      { drugId, drugName, drugInfo, drugEffect, drugImg, saleIds, pn, size, keyword }
    ) {
      modifyDrugInfo(drugId, drugName, drugInfo, drugEffect, drugImg, saleIds).then(() => {
        dispatch("getDrugInfo", { pn, size, keyword });
      });
    },
  };
