  ...
  methods: {
    initData() {
      getAllDashboardInfo().then((res) => {
        ...
        this.docLevel.push(dashboardData.docLevel[11])
        this.docLevel.push(dashboardData.docLevel[12])
        this.docLevel.push(dashboardData.docLevel[13])
        this.histogram();
