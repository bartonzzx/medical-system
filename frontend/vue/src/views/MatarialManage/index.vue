      ...
      <el-main>
        ...
        >
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="handleAddMaterial('addForm')">确定</el-button>
          </div>
        </el-dialog>
        <!-- 点击修改后的弹窗 -->
        <el-dialog
        ...
        >
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="handleModifyMaterial('modifyForm')">确定</el-button>
          </div>
        </el-dialog>
      </el-main>
    </el-container>
